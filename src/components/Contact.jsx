...
const contactItems = [
  { icon: <MdPhone style={{ fontSize: 22 }} />,      label: 'Phone / WhatsApp', value: <a href="tel:+918460811110">+91 84608 11110</a> },
  { icon: <MdEmail style={{ fontSize: 22 }} />,      label: 'Email',            value: <a href="mailto:support@taxiaapki.com">support@taxiaapki.com</a> },
  { icon: <MdLocationOn style={{ fontSize: 22 }} />, label: 'Office Address',   value: <span>Office No. 509, "SILVER PRIME", Rail Nagar, Rajkot – 360001</span> },
  { icon: <MdAccessTime style={{ fontSize: 22 }} />, label: 'Working Hours',    value: <span>24 Hours / 7 Days a Week</span> },
]
      ...
      <div className="container">
        ...
        <div className="contact-inner">
          ...
          <div ref={infoRef} className={`contact-info reveal reveal-left${infoVisible ? ' visible' : ''}`}>
            <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>Contact RK taxi service</h3>
            <p className="text-sm leading-relaxed mb-5" style={{ color: 'var(--text-secondary)' }}>
              Reach out to us for bookings, travel inquiries, corporate tie-ups, or general queries. We're available 24×7 to assist you.
            </p>
              ...
              {contactItems.map(item => (
                <div className="contact-card" key={item.label}>
                  ...
                  <div className="cc-text">
                    <strong className="text-sm font-semibold block mb-0.5" style={{ color: 'var(--text-primary)' }}>{item.label}</strong>
            ...
            <div className="contact-social">
              <a href="https://facebook.com/taxiaapki"       target="_blank" rel="noopener noreferrer" className="social-btn"><FaFacebook style={{ fontSize: 16 }} /> Facebook</a>
              <a href="https://www.instagram.com/taxi_aapki" target="_blank" rel="noopener noreferrer" className="social-btn"><FaInstagram style={{ fontSize: 16 }} /> Instagram</a>
            </div>
          </div>
          ...
          <div ref={formRef} className={`contact-form-card reveal reveal-right${formVisible ? ' visible' : ''}`}>
            {!sent ? (
              <>
                <h3 className="text-xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>Send Us a Message</h3>
              ...
              <div className="cf-success">
                ...
                <h4 className="text-lg font-bold mt-3 mb-2" style={{ color: 'var(--text-primary)' }}>Message Sent!</h4>
                <p className="text-sm mb-4" style={{ color: 'var(--text-secondary)' }}>Thanks for contacting RK taxi service. Our team will get back to you within 1 hour.</p>
                <button
