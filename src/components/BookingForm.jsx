...
const CAB_TYPES = [
  ...
  },
  {
    ...
    image: "https://img.icons8.com/comic/100/suv.png",
  },
  {
    id: "luxury",
    label: "Luxury",
    desc: "Premium comfort",
    image: "https://img.icons8.com/ios/50/limousine-car.png",
  },
  {
    id: "tempo",
    label: "Tempo",
    desc: "Up to 12 passengers",
    image: "https://img.icons8.com/carbon-copy/100/car--v1.png",
    fallback: "🚌",
  },
];
    ...
    <section className="booking-section" id="booking">
      <div className="container">
        ...
        >
          ...
          <p>
            Fill in your trip details and we'll arrange the perfect cab for you
            in minutes.
          </p>
        </div>
        ...
        <div className="booking-wrapper">
          {!submitted ? (
            ...
            >
                    ...
                    >
                      <div className="cab-img-wrap">
                        {cab.image ? (
                          ...
                          <span className="cab-img-fallback cab-img-fallback--visible">
                            {cab.fallback}
                          </span>
                        )}
                      </div>
              ...
              <div className="form-row">
                <div
                  className={`form-group ${errors.pickup ? "has-error" : ""}`}
                >
                  ...
                  />
                  {errors.pickup && (
                    <span className="error-msg">{errors.pickup}</span>
                  )}
                </div>
                <div className={`form-group ${errors.drop ? "has-error" : ""}`}>
                  ...
                  />
                  {errors.drop && (
                    <span className="error-msg">{errors.drop}</span>
                  )}
                </div>
              </div>
            ...
            >
              ...
              <p>
                ...
                <strong>{cabType.toUpperCase()}</strong> cab has been booked for
                a <strong>{tripType}</strong> trip.
              </p>
              ...
              <p className="success-note">
                Our team will contact you at <strong>{form.phone}</strong> to
                confirm your ride. Your booking details have been sent to us on
                WhatsApp! 🎉
              </p>
              <a
          ...
          >
            <div className="info-card">
              ...
              <a href="tel:+918460811110" className="info-phone">
                +91 84608 11110
              </a>
            </div>
            <div className="info-card highlight">
              ...
              <p>
                Our cabs are available round the clock, every day of the year.
              </p>
            </div>
            <div className="info-card">
              <div className="info-icon">💰</div>
              ...
              <p>
                Transparent pricing with zero hidden charges. What you see is
                what you pay.
              </p>
            </div>
            <div className="info-card">
              ...
              <h4>Safe & Secure</h4>
              <p>
                All drivers are background-verified. Real-time GPS tracking on
                every ride.
              </p>
            </div>
          </div>
