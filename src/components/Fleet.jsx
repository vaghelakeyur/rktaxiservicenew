...
function FareList() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("set-fare-category", handleCategory);
  }, []);
    ...
    <div className="fare-section">
      ...
      >
        ...
        <div
          className="fare-tabs"
          role="tablist"
          aria-label="Vehicle category tabs"
        >
        ...
        <div className="fare-table-wrap">
          <table
            ...
            aria-label={`${current.heading} pricing`}
          >
            <thead>
              <tr>
    ...
    <div className="fleet-card">
      ...
      <div className="fleet-info">
        ...
        <div className="fleet-features">
          {car.features.map((f) => (
            <span key={f} className="fleet-feature-badge">
              {f}
            </span>
          ))}
        </div>
    ...
    <section className="fleet-section" id="fleet">
      <div className="container">
        ...
        >
          ...
          <p>
            Well-maintained vehicles to suit every budget and group size. All
            cabs are AC, GPS-tracked, and sanitized.
          </p>
        </div>
      </div>
