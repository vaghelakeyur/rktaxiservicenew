          ...
          <div className="footer-col">
            ...
            <div className="footer-contact">
              <div className="fc-item">
                <MdLocationOn style={{ fontSize: 18, color: '#7c3aed', flexShrink: 0 }} />
                <span>Office No. 509, "SILVER PRIME", Rail Nagar, Rajkot – 360001, Gujarat</span>
              </div>
              <div className="fc-item">
                <MdPhone style={{ fontSize: 18, color: '#7c3aed', flexShrink: 0 }} />
                <a href="tel:+918460811110">+91 84608 11110</a>
              </div>
              <div className="fc-item">
                <MdEmail style={{ fontSize: 18, color: '#7c3aed', flexShrink: 0 }} />
                <a href="mailto:support@taxiaapki.com">support@taxiaapki.com</a>
              </div>
              <div className="fc-item">
                <MdAccessTime style={{ fontSize: 18, color: '#7c3aed', flexShrink: 0 }} />
