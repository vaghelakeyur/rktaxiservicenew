...
const RKLogo = memo(function RKLogo() {
  return (
    <div className="flex items-center gap-2">
      <svg className="rk-logo-svg" viewBox="0 0 120 70" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path d="M5 46 C5 46 8 34 18 28 C24 24 32 20 44 18 C54 16 66 16 76 19 C88 22 96 28 104 34 C110 38 114 42 115 46 C116 50 114 54 110 55 L10 55 C6 55 4 52 5 46 Z" stroke="#f5c518" strokeWidth="2.2" fill="none" strokeLinejoin="round"/>
        <path d="M30 28 C34 18 44 12 56 11 C66 10 76 13 84 20 C90 25 94 28 94 28" stroke="#f5c518" strokeWidth="2.2" fill="none" strokeLinecap="round"/>
        ...
        <path d="M104 36 C110 38 116 42 118 47 C119 50 118 54 115 55" stroke="#f5c518" strokeWidth="2" fill="none" strokeLinecap="round"/>
        <path d="M5 46 C3 44 1 40 3 36 C5 32 10 30 14 30" stroke="#f5c518" strokeWidth="2" fill="none" strokeLinecap="round"/>
      ...
      <div className="flex flex-col leading-tight">
        ...
        <span className="text-[10px] font-normal tracking-wide" style={{ color: 'var(--text-muted)' }}>Book your ride</span>
      </div>
    </div>
  )
})
